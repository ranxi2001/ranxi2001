...
| Area | Stack |
| --- | --- |
| **Languages** | Python · Go · TypeScript / JavaScript · SQL · Solidity |
| **Agents & AI** | Agent Loop · Tool Calling / MCP · Context / Memory · Multi-Agent · LangGraph · RAG |
| **Product & Data** | FastAPI · Node.js · Next.js / React · Vue · MySQL · Redis · Hive / Presto |
| **Infra, Quant & Web3** | Kubernetes · Docker · GitHub Actions · Freqtrade · Pandas · Solana / EVM |
